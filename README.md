...
<code style="color : darkorange">Click the link below to launch the interactive web page:</code> $${\color{darkorange}Click the link below to launch the interactive web page:}$$  
